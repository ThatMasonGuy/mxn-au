...
// Keep the exported schema object exactly in sync with the frontend file.
...
export const HANDOVER_ITEMS = {
    ...
    general: [
        ...
        {
            group: 'Maintenance Documentation',
            items: [
        ...
        },
        {
            ...
            items: [
                ...
                { id: 'doorCode', label: 'Door Code', type: 'text', placeholder: 'Enter door code' },
            ],
        },
        {
    ...
    stairs: [
        ...
        },
        {
            group: 'Lifts',
            items: [
                { id: 'liftServiceCompany', label: 'Lift Servicing Company Name', type: 'text', placeholder: 'Company name' },
                { id: 'liftServiceEmail', label: 'Lift Servicing Company Email Address', type: 'text', placeholder: 'service@example.com', showIf: { id: 'liftServiceCompany', hasValue: true } },
                { id: 'liftServicePhone', label: 'Lift Servicing Company Phone Number', type: 'text', placeholder: 'Phone number', showIf: { id: 'liftServiceCompany', hasValue: true } },
