...
export default [
    ...
    },
    {
        ...
        component: () => import('@/pages/topheroes/velaris/events/GvG_May_2025.vue'),
        meta: {
            requiresAuth: false,
            role: null,
            title: 'GvG Stats - May 25',
            drawerRanking: 1,
            drawerVisible: false,
            layout: 'default',
            description: 'Guild vs Guild event statistics for Velaris.',
    ...
    {
        path: '/topheroes/velaris/events/guild-vs-guild/may-2025-old',
        name: 'Velaris Event - GvG May OLD',
        component: () => import('@/pages/topheroes/velaris/events/GvG_May_2025-OLD.vue'),
        meta: {
            requiresAuth: false,
            role: null,
            title: 'GvG Stats - May 25 OLD',
            drawerRanking: 1,
            drawerVisible: false,
            layout: 'default',
            description: 'Guild vs Guild event statistics for Velaris.',
    ...
    {
        path: '/topheroes/velaris/events/guild-vs-guild/april-2025-old',
        name: 'Velaris Event - GvG April 25 OLD',
        component: () => import('@/pages/topheroes/velaris/events/GvG_April_2025-OLD.vue'),
        meta: {
            requiresAuth: false,
            role: null,
            title: 'GvG Stats - April 25 OLD',
            drawerRanking: 1,
            drawerVisible: false,
            layout: 'default',
            description: 'Guild Race event statistics for Velaris.',
