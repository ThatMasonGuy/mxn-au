...
export default [
    ...
    },
    {
        ...
        component: () => import('@/pages/topheroes/datasets/DatasetBuilder.vue'),
        meta: {
            requiresAuth: true,
            role: null,
    ...
    },
    {
        ...
        component: () => import('@/pages/topheroes/datasets/RankingsView.vue'),
        meta: {
            requiresAuth: true,
            role: null,
            title: 'Server Ranking',
    ...
    // UPDATED: Changed from path param to query params
    {
        ...
        name: 'RankingsPublic',
        component: () => import('@/pages/topheroes/datasets/PublicRankings.vue'),
        meta: {
            requiresAuth: false,
            role: null,
            title: 'Server Ranking',
    ...
    },
    {
        ...
        component: () => import('@/pages/topheroes/datasets/PublicRankingsIndex.vue'),
        meta: {
            requiresAuth: false,
            role: null,
    ...
    },
    {
        ...
        name: 'PublicInsights',
        component: () => import('@/pages/topheroes/datasets/PublicInsights.vue'),
        meta: {
            requiresAuth: false,
            role: null,
            title: 'Server Ranking',
    ...
    },
    {
        ...
        component: () => import('@/pages/topheroes/datasets/DataExplorer.vue'),
        meta: {
            requiresAuth: false,
            role: null,
            title: 'Server Ranking',
    ...
    },
    {
        ...
        component: () => import('@/pages/topheroes/datasets/MigrationTool.vue'),
        meta: {
            requiresAuth: false,
            role: null,
            title: 'Server Ranking',
    ...
    },
    {
        ...
        component: () => import('@/pages/topheroes/velaris/admin/Home.vue'),
        meta: {
            requiresAuth: true,
            role: ROLES.TOPHEROES_ADMIN,
