...
<template>
    <div>
        ...
        <div class="mb-6 flex flex-wrap items-center gap-3">
            ...
            <div v-if="getUpcomingEvents().length > 0"
        ...
        <div v-if="loading" class="elev-card p-12 text-center">
            <div class="max-w-md mx-auto">
                <div
                    class="w-16 h-16 bg-gradient-to-br from-velaris-purple to-velaris-teal rounded-full mx-auto mb-4 flex items-center justify-center">
        ...
        <div v-else>
            ...
            <div v-if="viewMode === 'card'" class="grid gap-6 lg:grid-cols-2 xl:grid-cols-3">
                <TransitionGroup name="card-fade">
                    <div v-for="event in filteredEvents" :key="event.id" class="event-card" @click="editEvent(event)">
            ...
            <!-- Results Summary -->
            <div
                class="mt-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 text-sm text-foreground/60 elev-card p-4">
