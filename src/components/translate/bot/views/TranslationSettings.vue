...
<template>
    <div>
            ...
            <div v-show="activeTab === 'messages'" class="space-y-6">
                <div class="translate-card">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div class="flex items-center gap-3">
                            <div class="flex items-center gap-2">
                                <span class="text-sm text-zinc-400">Reaction Roles {{ config.enabled ? 'Enabled' : 'Disabled' }}</span>
                    ...
                    <div v-if="config.enabled">
                        <div v-if="reactionMessages.length === 0" 
                        ...
                        <div v-else class="space-y-4">
                            <div v-for="(message, index) in reactionMessages" :key="message.id"
                                ...
                                <div class="flex items-start justify-between mb-4">
                                    <div class="flex-1">
                                        <h4 class="font-semibold text-white mb-1">{{ message.title || 'Untitled Message' }}</h4>
                                        <p class="text-sm text-zinc-400"># {{ getChannelName(message.channelId) }} • {{ message.reactions.length }} reactions</p>
                                    ...
                                    <div class="flex items-center gap-2 ml-4">
                                        ...
                                        <button @click="deleteMessage(index)" class="translate-btn-secondary text-sm text-red-400">
                                ...
                                <div class="grid grid-cols-3 gap-4 text-center text-sm">
                                    <div>
                                        <div class="font-medium text-white">{{ message.stats?.totalReactions || 0 }}</div>
                        ...
                        <div class="setting-item">
                            <div class="setting-label">
                                ...
                                <div>
                                    ...
                                    <div class="text-sm text-zinc-400">Users can react to multiple emojis on the same message</div>
                                </div>
                            </div>
                        ...
                        <div class="setting-item">
                            <div class="setting-label">
                                ...
                                <div>
                                    ...
                                    <div class="text-sm text-zinc-400">Only verified Discord accounts can use reaction roles</div>
                                </div>
                            </div>
                    ...
                    <div class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input v-model.number="config.maxRolesPerUser" 
                                    type="number" min="1" max="50" class="translate-input" />
                            ...
                            <div>
                                ...
                                <input v-model.number="config.maxRolesPerMessage" 
                                    type="number" min="1" max="20" class="translate-input" />
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="space-y-2">
                                <div v-for="role in restrictedRoles" :key="role.id" 
                                    ...
                                    <button @click="removeRestrictedRole(role.id)" class="text-red-400 hover:text-red-300">
                                        <X class="h-3 w-3" />
                                    </button>
                                </div>
        ...
        <div v-if="showCreateMessage" class="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
            <div class="translate-glass-card w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                ...
                <ReactionMessageCreator 
                    :available-channels="availableChannels"
                    :available-roles="availableRoles"
                    @save="saveReactionMessage"
