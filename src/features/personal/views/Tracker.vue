...
import GoblinHeader from '@/features/personal/components/tracker/GoblinHeader.vue';
import GoblinForm from '@/features/personal/components/tracker/GoblinForm.vue';
