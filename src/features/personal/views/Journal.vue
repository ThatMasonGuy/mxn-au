...
import { useJournalChatStore } from '@/features/personal/stores/useJournalChatStore';
import { useMainStore } from '@/shared/stores/useMainStore';
import { getFunctions, httpsCallable } from 'firebase/functions';

import SidebarLayout from '@/features/personal/components/journal/layouts/Sidebar.vue';
import ChatLayout from '@/features/personal/components/journal/layouts/Chat.vue';
import UserSettingsModal from '@/features/personal/components/journal/JournalProfileModal.vue';
import { useJournalChatCreator } from '@/features/personal/composables/useJournalChatCreator';
import { useSendJournalMessage } from '@/features/personal/composables/useSendJournalMessage'
