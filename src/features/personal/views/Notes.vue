...
import { useNotesStore } from '@/features/personal/stores/useNotesStore'
import Sidebar from '@/features/personal/components/notes/layouts/Sidebar.vue'
import Notes from '@/features/personal/components/notes/layouts/Notes.vue'
