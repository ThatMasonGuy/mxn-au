<template>
  <div class="relative group">
    <div
      ...
      tabindex="0"
      @keydown.enter.prevent="selectChatItem"
    ...
    >
      ...
      <div class="flex-1 min-w-0">
        <div v-if="isRenaming" class="flex items-center gap-2">
          <input
            v-model="localRenameInput"
            @keyup.enter="confirmRenameItem"
            @blur="cancelRenameItem"
    ...
    <div
      ...
      @click="selectChatItem"
      :class="[
        'mx-auto mb-3 rounded-lg flex items-center justify-center cursor-pointer w-10 h-10',
        isSelected
          ? 'bg-indigo-100 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400'
...
const isContextMenuOpen = computed(
  () => props.isContextMenuOpenGlobal === props.chat.id,
);
