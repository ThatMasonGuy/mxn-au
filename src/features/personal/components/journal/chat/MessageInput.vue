  ...
  <div class="border-t border-zinc-200 dark:border-zinc-800 p-4">
    ...
    >
      <textarea
        ...
        class="flex-grow resize-none bg-transparent outline-none text-zinc-900 dark:text-zinc-100 h-auto"
        ref="messageInputRef"
      ></textarea>
      <button
        @click="sendMessage"
        :disabled="isThinking || !localNewMessage.trim()"
        :class="[
...
<script setup>
import { computed, ref, watch, defineEmits, nextTick, onMounted } from "vue";
