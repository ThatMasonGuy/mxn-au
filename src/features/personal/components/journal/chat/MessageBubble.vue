<template>
  ...
  <div
    ...
    :class="message.sender === 'ai' ? 'items-start' : 'items-end'"
  >
    <div
      :class="[
        'flex gap-4 min-w-0',
    ...
    >
      ...
      >
        ...
        <div
          :class="[
            'text-xs mt-2',
            message.sender === 'ai' ? 'text-zinc-400' : 'text-indigo-200',
          ]"
        >
...
<script setup>
import MarkdownText from "@/features/personal/components/journal/MarkdownText.vue";
