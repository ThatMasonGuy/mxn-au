<template>
  <div class="mb-4">
    ...
    <SidebarItem
      ...
      :is-context-menu-open-global="actionMenuOpenId"
      :renaming-note-id-global="renamingNoteId"
      ...
      @confirm-rename="
        ($event, newName) => $emit('confirm-rename', $event, newName)
      "
      @cancel-rename="$emit('cancel-rename')"
      @archive-note="$emit('archive-note', $event)"
