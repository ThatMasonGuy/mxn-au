...
import DashboardHome from '@/features/translate/components/bot/views/DashboardHome.vue'
import AutoTranslateConfig from '@/features/translate/components/bot/views/AutoTranslateConfig.vue'
import AnnouncementsConfig from '@/features/translate/components/bot/views/AnnouncementsConfig.vue'
import GeneralSettings from '@/features/translate/components/bot/views/GeneralSettings.vue'
import RestrictionsConfig from '@/features/translate/components/bot/views/RestrictionsConfig.vue'
import AuditTrail from '@/features/translate/components/bot/views/AuditTrail.vue'
import CalendarView from '@/features/translate/components/bot/views/CalendarView.vue'
import {
    Bot,
    LogOut,
    ChevronRight,
