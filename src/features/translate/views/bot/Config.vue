...
import ConfigSection from '@/features/translate/components/bot/config/ConfigSection.vue'
import ToggleSwitch from '@/features/translate/components/bot/config/ToggleSwitch.vue'
import ChannelSelector from '@/features/translate/components/bot/config/ChannelSelector.vue'
import LanguageSelector from '@/features/translate/components/bot/config/LanguageSelector.vue'
import { 
    ArrowLeft, 
    Save, 
    Loader2, 
