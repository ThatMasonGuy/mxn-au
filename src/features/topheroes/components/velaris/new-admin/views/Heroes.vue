...
// Components
import HeroCard from '@/features/topheroes/components/HeroCard.vue'
...
import SyncModal from '@/features/topheroes/components/modals/SyncModal.vue'
import HeroModal from '@/features/topheroes/components/modals/HeroModal.vue'
