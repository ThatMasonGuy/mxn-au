  ...
  <div>
    ...
    <div class="mb-6">
      ...
      <p class="text-sm text-foreground/70 mt-1">
        Configure your admin dashboard and guild preferences
      </p>
    </div>

    <!-- Settings Navigation -->
    <div
      class="mb-8 flex flex-wrap gap-1 p-1 bg-card rounded-lg ring-1 ring-border/60"
    >
      <button
    ...
    <div class="space-y-8">
      ...
      <div v-show="activeTab === 'general'" class="space-y-6">
        <div class="elev-card">
          <h3 class="font-semibold text-velaris-purple mb-4">
            General Preferences
          </h3>
          <div class="space-y-6">
            <!-- Theme Selection -->
            <div class="setting-item">
              ...
              <div class="flex gap-2 items-center">
                ...
                <!-- Froggy button -->
                <button
                  class="theme-option relative overflow-hidden"
                  :class="{
                    'active bg-green-500 text-white hover:bg-green-600 dark:bg-green-600 dark:hover:bg-green-700':
                      store.themeVariant === 'froggy',
                    'text-foreground/70 hover:text-foreground hover:bg-foreground/5':
                      store.themeVariant !== 'froggy',
                  }"
                ...
                >
                  <!-- Soft green overlay -->
                  <span
                    class="absolute inset-0 bg-green-400/10 pointer-events-none"
                  ></span>
            ...
            <div class="setting-item">
              <div class="setting-label">
                ...
                <div>
                  ...
                  <div class="text-sm text-foreground/60">
                    How the sidebar appears on load
                  </div>
                </div>
              </div>
              <div
            ...
            <div class="setting-item">
              <div class="setting-label">
                ...
                <div>
                  ...
                  <div class="text-sm text-foreground/60">
                    Show condensed metrics view
                  </div>
                </div>
              </div>
              <div
                class="toggle-switch"
                :class="{ active: store.compactKPIs }"
          ...
          <div class="space-y-6">
            ...
            >
              <div class="setting-label">
                <component
                  :is="notif.icon"
                  class="h-5 w-5 text-velaris-purple"
                />
                <div>
        ...
        <div class="elev-card">
          ...
          <div class="space-y-6">
            <div class="setting-item">
              ...
              <button class="btn-solid-purple">Enable 2FA</button>
            </div>
            ...
            <div class="setting-item">
              ...
              <button class="btn-soft-violet">Manage Keys</button>
            </div>
            ...
            <div class="setting-item">
              ...
              <button class="btn-soft-violet">View Activity</button>
            </div>
          </div>
        </div>
          ...
          <div class="space-y-3">
            ...
            >
              <div class="flex items-center gap-3">
                ...
                >
                  <component
                    :is="session.device === 'desktop' ? Monitor : Smartphone"
                ...
                <div class="text-right">
                  ...
                  <span
                    ...
                    :class="
                      session.current
                        ? 'bg-velaris-green/15 text-velaris-green'
          ...
          <div class="grid gap-4 sm:grid-cols-2">
            ...
            >
              <div class="flex items-center justify-between mb-3">
                ...
                <div
                  class="toggle-switch"
                  :class="{ active: integration.connected }"
