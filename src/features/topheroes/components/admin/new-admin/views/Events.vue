...
import ConfirmDialog from '@/features/topheroes/components/velaris/ConfirmDialog.vue'
...
const EventEditComponent = defineAsyncComponent({
    loader: () => import('@/features/topheroes/components/velaris/new-admin/views/EventEdit.vue'),
