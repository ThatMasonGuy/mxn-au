...
<template>
  <header class="sticky top-0 z-40 h-16">
    <div
      class="h-full bg-gradient-to-r from-th-primary via-th-secondary to-th-success"
    >
      <div class="flex h-full items-center gap-3 px-4">
        ...
        <div class="flex items-center gap-3 text-white">
          <!-- TopHeroes Icon/Logo -->
          <div
            class="h-7 w-7 rounded-full bg-white/20 flex items-center justify-center"
          >
        ...
        <div class="relative ml-4 hidden flex-1 md:flex">
          <div class="mx-auto w-full max-w-7xl">
            <div class="relative">
              ...
              />
              <Search
                class="absolute left-2.5 top-1/2 -translate-y-1/2 h-4 w-4 text-white"
              />
            </div>
          </div>
        </div>
        ...
        <div class="ml-auto flex items-center gap-2">
          ...
          >
            <span
              :class="[
                'inline-block h-2 w-2 rounded-full',
                isPublishing ? 'bg-blue-300 animate-pulse' : 'bg-blue-300',
              ]"
            ></span>
            {{ publishText }}
          </button>
          ...
          <button
            ...
            :aria-pressed="store.settings.isDark"
