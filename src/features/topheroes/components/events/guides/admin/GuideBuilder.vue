<template>
  <div class="space-y-8">
    ...
    <div
      ...
      class="rounded-xl border-2 border-dashed border-zinc-700 p-12 text-center"
    >
    ...
    <TransitionGroup name="list" tag="div" class="space-y-4">
      ...
      >
        ...
        >
          <div
            class="bg-zinc-900 px-4 py-3 flex items-center justify-between border-b border-zinc-700"
          >
            <div class="flex items-center">
              <span
                class="text-xs uppercase tracking-wider font-mono text-purple-300 mr-2"
              >
                {{ block.type }}
              </span>
              <span class="text-zinc-400 text-xs"
                >ID: {{ block.id.substring(0, 8) }}</span
              >
            </div>
            ...
            <div class="flex items-center space-x-2">
              ...
              >
                <svg
                  ...
                  :class="{ 'rotate-180': expandedBlocks[block.id] }"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
