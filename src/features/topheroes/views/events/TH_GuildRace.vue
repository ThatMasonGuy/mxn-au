...
import { useTopHeroesStore } from '@/features/topheroes/stores/useTopHeroesStore'
import Timeline from '@/shared/components/ui/Timeline.vue'
import GuideHeader from '@/features/topheroes/components/guide/GuideHeader.vue'
import ContentSection from '@/features/topheroes/components/guide/ContentSection.vue'
import LoadingSkeleton from '@/features/topheroes/components/guide/LoadingSkeleton.vue'
import RefreshButton from '@/features/topheroes/components/guide/RefreshButton.vue'

const author = '[VLR]Velvet in s10154'
defineExpose({ author })
...
import { useTimeOffset } from '@/shared/utils/useTimeOffset'
