<!-- @/features/topheroes/views/velaris/events/layouts/PlayerComparison/ComparisonPlayerCard.vue -->
<template>
  <div
    class="border rounded-xl p-4 shadow bg-card transition-transform transform hover:-translate-y-1 hover:shadow-lg"
    :style="cardStyle"
    @mouseenter="$emit('hover', player.Player)"
