<!-- @/features/topheroes/views/velaris/events/layouts/EventTable.vue -->
<template>
  <div
    :class="[
      styling.wrapper ||
        'bg-card border border-border shadow-md overflow-hidden rounded-lg',
    ]"
  >
    <!-- Loading State -->
      ...
      <table class="min-w-full text-sm overflow-hidden rounded-lg">
          ...
          <tr :class="columnLines">
            <th
              ...
              :class="[
                ...
                eventStore.sortField === col.key
                  ? selectedColumnHeaderClass
                  : '',
              ]"
            >
              <div
        ...
        <tbody>
          ...
          >
            ...
            <td
              v-if="actions.length > 0"
              :class="['px-4', rowPadding, 'text-right']"
            >
