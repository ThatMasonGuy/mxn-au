...
import WorkbenchCard from '@/features/topheroes/views/velaris/events/layouts/Cards/WorkbenchCard.vue'
import WorkbenchChart from '@/features/topheroes/views/velaris/events/layouts/Charts/WorkbenchChart.vue'
import { useCastleScoreOption } from '@/features/topheroes/views/velaris/events/layouts/Charts/options/castleScoreOption'
import { useRoleScoreOption } from '@/features/topheroes/views/velaris/events/layouts/Charts/options/roleScoreOption'
import { usePowerScatterOption } from '@/features/topheroes/views/velaris/events/layouts/Charts/options/powerScatterOption'
import { useDailyPerformanceOption } from '@/features/topheroes/views/velaris/events/layouts/Charts/options/dailyPerformanceOption'
import { useTotalScorePieOption } from '@/features/topheroes/views/velaris/events/layouts/Charts/options/totalScorePieOption'
import { useComparisonDailyOption } from '@/features/topheroes/views/velaris/events/layouts/Charts/options/comparisonChartOption'
import { formatPlayerName } from '@/shared/utils/useFormatPlayerName'
import { useRoute, useRouter } from 'vue-router';
import { useEventDataStore } from '@/features/topheroes/stores/useEventDataStore'
import { useThemeStore } from '@/shared/stores/useThemeStore'
import BaduModal from '@/features/topheroes/views/velaris/admin/BaduModal.vue'
