...
import { Database, Calculator, Trophy, Save, Globe, BarChart3, ArrowRightLeft, CheckCircle, AlertCircle } from '@lucide/vue'
import { firestore } from '@/firebase'
import { doc, setDoc } from 'firebase/firestore'
import { useDatasetStore } from '@/features/topheroes/stores/useDatasetStore'
import { calculateRankings as calcRankings, createDefaultWeights } from '@/features/topheroes/lib/rankingCalculator'
import { removeUndefined } from '@/features/topheroes/lib/datasetHelpers'
import WeightConfig from '@/features/topheroes/components/rankings/WeightConfig.vue'
import RankingTable from '@/features/topheroes/components/rankings/RankingTable.vue'
