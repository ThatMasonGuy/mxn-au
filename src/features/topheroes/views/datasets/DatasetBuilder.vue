...
import EventConfigPanel from '@/features/topheroes/components/datasets/EventConfigPanel.vue'
import GuildTable from '@/features/topheroes/components/entry/GuildTable.vue'
