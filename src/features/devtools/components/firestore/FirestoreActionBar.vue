<template>
  <div
    class="bg-gray-900/80 rounded-2xl p-6 border border-gray-800 shadow-sm space-y-6"
  >
    <!-- Title and Actions -->
    <div
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div>
        <select
          :value="sortDirection"
          @change="$emit('update:sort-direction', $event.target.value)"
          class="w-full bg-gray-800 text-gray-200 border-gray-700 rounded-md px-3 py-2 text-sm focus:ring-indigo-500 focus:border-indigo-500"
        >
