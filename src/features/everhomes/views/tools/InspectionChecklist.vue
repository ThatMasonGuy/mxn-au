  ...
  <LayoutComponent :header="true" :footer="true">
    ...
    <div class="bg-slate-900 border-b border-slate-800">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 h-10 flex items-center gap-3">
        <span
          class="text-xs font-black tracking-wider text-violet-400 uppercase"
          >Everhomes</span
        >
        <span class="text-slate-700">|</span>
        <span class="text-xs font-semibold text-slate-400"
          >Property Inspection</span
        >
      </div>
    </div>
    ...
    <div class="">
      <div
        class="bg-gradient-to-r from-violet-700 to-fuchsia-600 px-4 sm:px-6 lg:px-8 pt-8 pb-10"
      >
        <div class="max-w-4xl mx-auto">
          <h1
            class="text-2xl sm:text-3xl font-black text-white tracking-tight uppercase"
          >
            Set Up Your Property
          </h1>
          <p class="text-violet-200 text-sm mt-1 font-medium">
            Configure rooms, select areas, and choose the report type.
          </p>
        </div>
      </div>
      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 -mt-5 pb-8">
        <div
          class="bg-white rounded-2xl shadow-xl shadow-black/15 overflow-hidden"
        >
          <!-- Report type selector -->
          <div class="bg-violet-50 border-b border-violet-100 px-5 py-4">
            <p
              class="text-[0.65rem] font-black text-violet-600 uppercase tracking-widest mb-2.5"
            >
              Report Type
            </p>
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-2">
              <button
                ...
                @click="!rt.disabled && (reportSubtype = rt.key)"
                ...
                :class="[
                  ...
                  rt.disabled
                    ? 'opacity-40 cursor-not-allowed hover:border-slate-200 hover:bg-white'
                    : '',
                ]"
                :title="
                  rt.disabled ? 'Entry/Exit reports are not ready for use' : ''
                "
              >
                {{ rt.label }}
              </button>
          ...
          <div
            class="bg-slate-50 border-b border-slate-200 px-5 py-4 space-y-3"
          >
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label
                  class="block text-[0.65rem] font-black text-violet-600 uppercase tracking-widest mb-1"
                ...
                />
                <p
                  v-if="setupErrors.address"
                  class="text-rose-500 text-[0.65rem] font-bold mt-1"
                >
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div>
                <label
                  class="block text-[0.65rem] font-black text-violet-600 uppercase tracking-widest mb-1"
                  >Everhomes Staff Email</label
                >
                <input
                  v-model="inspectorEmail"
                  type="email"
            ...
            <p class="text-[0.6rem] text-slate-400 -mt-1">
              This is the person completing the form. These details appear on
              the report and signature page.
            </p>
          </div>
          ...
          <div class="px-5 py-6 space-y-8">
            ...
            <div>
              <div class="flex items-center justify-between mb-4">
                ...
                <div class="flex items-center gap-3">
                  ...
                  <span
                    class="text-slate-800 font-black text-xl w-4 text-center tabular-nums"
              ...
              <div class="space-y-2.5">
                ...
                >
                  ...
                  />
                  <button
                    @click="bed.hasEnsuite = !bed.hasEnsuite"
            ...
            <div>
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <p class="text-[0.68rem] text-slate-400 font-medium mt-0.5">
                    Not counting ensuites above
                  </p>
                </div>
                <div class="flex items-center gap-3">
                  <button
            ...
            <div>
              ...
              <p class="text-[0.68rem] text-slate-400 font-medium mb-3">
                Always included in every inspection
              </p>
              <div class="flex flex-wrap gap-2">
                <div
                  v-for="s in CORE_SECTIONS"
                  :key="s.key"
            ...
            <div>
              ...
              <p class="text-[0.68rem] text-slate-400 font-medium mb-3">
                Add any that apply to this property
              </p>
              <div class="grid grid-cols-2 sm:grid-cols-3 gap-2">
                <button
                  v-for="area in OPTIONAL_AREAS"
                  :key="area.key"
                  @click="toggleOptional(area.key)"
                ...
                >
                  ...
                  >
                    <Check
                      v-if="selectedOptional.has(area.key)"
                      class="w-2.5 h-2.5 text-white"
                    />
                  </div>
                  {{ area.label }}
    ...
    <div data-checklist class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
      ...
      >
        ...
        <p class="text-sm font-semibold text-slate-400">
          Configure your property above<br /><span
            class="text-slate-500 font-normal"
            >then hit Start Inspection.</span
          >
        </p>
      </div>
      ...
      <template v-else>
        ...
        >
          ...
          <p class="text-xs text-amber-300/90 font-medium leading-relaxed">
            Room photos are
            <span class="font-bold text-amber-200">compressed</span> for the
            report. Use the Marketing Photos section below for uncompressed hero
            shots.
          </p>
        </div>
        ...
        <div
          class="mb-4 flex items-center justify-between px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-2xl"
        >
          <div class="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p class="text-[0.6rem] text-slate-500">
                Hero shots for listings — uploaded uncompressed
              </p>
            </div>
          </div>
          <button
            @click="showMarketing = !showMarketing"
          ...
          >
            <div
              class="w-5 h-5 rounded-full bg-white shadow transition-transform duration-200"
        ...
        <!-- Status legend -->
        <div
          class="mb-4 px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-2xl"
        >
          <p
          ...
          <div class="grid grid-cols-2 sm:grid-cols-4 gap-x-4 gap-y-2">
            <div class="flex items-start gap-2">
              <CheckCircle
                class="w-3.5 h-3.5 text-emerald-400 shrink-0 mt-px"
              />
              <div class="-mt-2">
                <span class="text-xs font-bold text-emerald-400 leading-none"
                  >Good</span
                >
                <p class="text-[0.6rem] text-slate-500 leading-tight mt-0.5">
            ...
            <div class="flex items-start gap-2">
              <AlertTriangle
                class="w-3.5 h-3.5 text-amber-400 shrink-0 mt-px"
              />
              <div class="-mt-2">
                <span class="text-xs font-bold text-amber-400 leading-none"
                  >Attention</span
                >
                <p class="text-[0.6rem] text-slate-500 leading-tight mt-0.5">
                  Minor issue — note for follow-up
                </p>
              </div>
            </div>
            <div class="flex items-start gap-2">
              ...
              <div class="-mt-2">
                <span class="text-xs font-bold text-rose-400 leading-none"
                  >Issue</span
                >
                <p class="text-[0.6rem] text-slate-500 leading-tight mt-0.5">
                  Requires action or repair
                </p>
              </div>
            </div>
            <div class="flex items-start gap-2">
              ...
              <div class="-mt-2">
                <span class="text-xs font-bold text-slate-400 leading-none"
                  >N/A</span
                >
                <p class="text-[0.6rem] text-slate-500 leading-tight mt-0.5">
        ...
        <div class="mb-5">
          ...
          <div class="flex items-center justify-between">
            <span class="text-xs text-slate-500 font-medium"
              >{{ inspectedCount }} / {{ checklistRooms.length }} rooms
              done</span
            >
            <span
              class="flex items-center gap-1 text-[0.65rem] font-semibold text-slate-600"
            >
        ...
        <div class="space-y-2">
          <div
            v-for="(room, idx) in checklistRooms"
            :key="room.id"
          ...
          >
            ...
            >
              <div
                ...
                :style="{
                  background:
                    ROOM_META[room.type]?.gradient ??
                    ROOM_META.bedroom.gradient,
                }"
              >
                <component
                  :is="ROOM_META[room.type]?.icon ?? Moon"
                  class="w-4 h-4"
                />
              </div>
              <div class="flex-1 min-w-0">
                <div class="flex items-center gap-1.5 flex-wrap">
                  ...
                  <span
                    v-if="room.isEnsuite"
                    class="text-[0.58rem] font-black uppercase text-sky-400 bg-sky-500/15 border border-sky-500/25 px-1.5 py-0.5 rounded-full"
                    >Ensuite</span
                  >
                </div>
                <p class="text-xs mt-0.5">
                  <span class="text-slate-500"
                    >{{ inspectionData[room.id]?.photos?.length ?? 0 }} photo{{
                      (inspectionData[room.id]?.photos?.length ?? 0) !== 1
                        ? "s"
                        : ""
                    }}
                    ·
                  ...
                  <span
                    :style="{
                      color: statusColour(inspectionData[room.id]?.status),
                    }"
              ...
              <div
                ...
                :style="{
                  background: statusColour(inspectionData[room.id]?.status),
                }"
              ></div>
              <ChevronDown
            ...
            >
              <div
                v-if="openRooms.has(idx) && inspectionData[room.id]"
              ...
              >
                ...
                <div class="pt-4">
                  <p
                    class="text-[0.65rem] font-black text-slate-500 uppercase tracking-widest mb-2"
                  >
                    Overall Status
                  </p>
                  ...
                  <template v-if="roomIsAllNA(room.id)">
                    ...
                    <div class="flex flex-wrap gap-2">
                      <button
                        ...
                        :class="
                          inspectionData[room.id].status === s.value
                            ? s.activeClass
                      ...
                      <component
                        :is="
                          STATUS_OPTIONS.find(
                            (s) =>
                              s.value ===
                              (inspectionData[room.id].status || 'unchecked'),
                          )?.icon ?? MinusCircle
                        "
                ...
                <div v-if="getChecklistGroups(room.type).length">
                  ...
                  <div class="space-y-4">
                    <div
                      v-for="group in getChecklistGroups(room.type)"
                      :key="group.group"
                    >
                      <!-- Group header -->
                      <div class="flex items-center gap-2 mb-1.5">
                        <span
                          v-if="group.sda"
                          class="text-[0.55rem] font-black uppercase tracking-wider text-violet-400 bg-violet-500/15 border border-violet-500/25 px-1.5 py-0.5 rounded-full"
                          >SDA</span
                        >
                        <span
                        ...
                        <div
                          ...
                          :class="
                            item.type
                              ? ''
                              : itemRowClass(
                                  inspectionData[room.id].items?.[item.id],
                                )
                          "
                        >
                          ...
                          <template v-if="item.type">
                            ...
                            <input
                              ...
                              :value="
                                inspectionData[room.id].inputs?.[item.id] ?? ''
                              "
                              @input="
                                setItemInput(
                                  room.id,
                          ...
                          <template v-else>
                            ...
                            <div class="flex items-center gap-0.5 shrink-0">
                              <button
                                v-for="s in ITEM_STATUS_OPTIONS"
                                :key="s.value"
                                @click="
                                  setItemStatus(room.id, item.id, s.value)
                                "
                                :title="s.label"
                ...
                <div>
                  <label
                    class="block text-[0.65rem] font-black text-slate-500 uppercase tracking-widest mb-1.5"
                    >Notes</label
                  >
                  <textarea
                    v-model="inspectionData[room.id].notes"
                    rows="3"
                ...
                <div>
                  <div class="flex items-center justify-between mb-2">
                    <p
                      class="text-[0.65rem] font-black text-slate-500 uppercase tracking-widest"
                    >
                      Photos
                    </p>
                    <button
                  ...
                  <div
                    v-if="inspectionData[room.id].photos.length"
                    class="grid grid-cols-3 sm:grid-cols-4 gap-2"
                  >
                    <div
                      v-for="(photo, pIdx) in inspectionData[room.id].photos"
                      :key="pIdx"
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <span
                            class="text-[9px] font-bold text-rose-200 text-center leading-tight"
                            >Upload failed</span
                          >
                          <button
                            @click.stop="retryPhotoUpload(room.id, pIdx)"
                        ...
                        <!-- Skipped overlay -->
                        <div
                          v-else-if="photo.uploadStatus === 'skipped'"
                        ...
                        >
                          ...
                          <span
                            class="text-[9px] text-amber-200 font-bold text-center leading-tight"
                            >Send manually</span
                          >
                        </div>
                  ...
                  >
                    ...
                    <p class="text-xs text-amber-300 font-medium leading-tight">
                      Some photos failed to upload. Please email them directly
                      to
        ...
        <div
          v-if="showMarketing"
          class="mt-6 bg-gradient-to-b from-violet-900/20 to-slate-900/50 border border-violet-500/20 rounded-2xl overflow-hidden"
        >
          <div class="px-5 py-4 border-b border-violet-500/15 bg-violet-500/5">
            ...
            <p class="text-[0.65rem] text-slate-400 leading-relaxed">
              These hero shots are for marketing and listing purposes. They are
              uploaded
              <span class="font-bold text-violet-300">uncompressed</span> and
              will <span class="font-bold text-violet-300">not</span> appear in
              the compliance report.
            </p>
          </div>
          <div class="px-5 py-4 space-y-3">
            <div
              v-for="slot in MARKETING_SLOTS"
              :key="slot.key"
            ...
            >
              <div class="flex items-center justify-between mb-2">
                <div>
                  ...
                  <p class="text-[0.6rem] text-slate-500 mt-0.5">
                    {{ slot.hint }}
                  </p>
                </div>
                <label
              ...
              <div
                v-if="(marketingPhotos[slot.key] ?? []).length"
                class="grid grid-cols-3 sm:grid-cols-4 gap-2"
              >
                <div
                  v-for="(photo, mpIdx) in marketingPhotos[slot.key]"
                  :key="mpIdx"
                  class="relative group aspect-square rounded-xl overflow-hidden border-2"
                  :class="
                    photo.uploadStatus === 'uploading'
                ...
                >
                  ...
                  >
                    <AlertTriangle class="w-4 h-4 text-rose-300" />
                    <span class="text-[9px] font-bold text-rose-200"
                      >Failed</span
                    >
                  </div>
                  <button
        ...
        <div class="mt-6 pt-6 border-t border-slate-700/50">
          ...
          <p class="text-center text-xs text-slate-600 font-medium mt-2">
            {{
              uninspectedCount > 0
                ? `${uninspectedCount} room${uninspectedCount !== 1 ? "s" : ""} still
                        unchecked`
                : "All rooms inspected ✓"
            }}
          </p>
          ...
          >
            ...
            >
              ...
              >
                ...
                <div>
                  <h3 class="text-white font-black text-lg">
                    {{ submitModal.statusMessage }}
                  </h3>
                  <p class="text-slate-400 text-sm mt-1">
                    This takes around 30–60 seconds. Don't close this page.
                  </p>
                </div>
                <button
                  v-if="submitModal.canFlush"
                  @click="flushAndCheck"
              ...
              >
                ...
                <a
                  v-if="submitModal.pdfUrl"
                  :href="submitModal.pdfUrl"
                  target="_blank"
              ...
              <template v-else>
                ...
                <div v-if="flaggedRooms.length" class="px-5 pt-4">
                  ...
                  <div class="space-y-1.5">
                    ...
                    >
                      ...
                      <div class="flex-1 min-w-0">
                        <p
                          class="text-white text-xs font-bold leading-tight truncate"
                        >
                          {{ room.label }}
                        </p>
                        <p
                      ...
                      <component
                        :is="room.status === 'issue' ? XCircle : AlertTriangle"
                        class="w-4 h-4 shrink-0"
                        :style="{ color: statusColour(room.status) }"
                      />
                    </div>
                ...
                >
                  ...
                  />
                  <p class="text-xs text-violet-300 font-semibold">
                    Some photos are still uploading — please wait before
                    submitting.
                  </p>
                </div>

                <div
                  v-if="uninspectedCount > 0"
                ...
                >
                  ...
                  <p class="text-xs text-amber-300 font-semibold">
                    {{ uninspectedCount }} room{{
                      uninspectedCount !== 1 ? "s" : ""
                    }}
                ...
                <!-- ── Signature Section ─────────────────────── -->
                <div
                  class="mx-5 mt-5 border border-slate-700 rounded-xl overflow-hidden"
                >
                  <div
                    class="bg-slate-800/50 px-4 py-3 border-b border-slate-700"
                  >
                    <p
                      class="text-xs font-black text-slate-400 uppercase tracking-widest"
                    >
                  ...
                  <div class="px-4 py-4 space-y-3">
                    <div class="flex items-center justify-between text-xs">
                      <span class="text-slate-400">{{
                        inspectorName || "Staff name not set"
                      }}</span>
                      <span class="text-slate-500">{{
                        formatDate(inspectionDate)
                      }}</span>
                    ...
                    >
                      ...
                      />
                      <span
                        class="text-[0.65rem] text-slate-400 leading-relaxed"
                      >
                        I,
                        <span class="font-bold text-white">{{
                          inspectorName || "___"
                        }}</span
                        >, confirm that this inspection was completed on
                        <span class="font-bold text-white">{{
                          formatDate(inspectionDate) || "___"
                        }}</span>
                        and that the information recorded is accurate to the
                ...
                <template
                  v-if="reportSubtype === 'entry' || reportSubtype === 'exit'"
                >
                  <div
                    class="mx-5 mt-4 border border-slate-700 rounded-xl overflow-hidden"
                  >
                    <div
                      class="bg-slate-800/50 px-4 py-3 border-b border-slate-700"
                    >
                      ...
                      <p class="text-[0.6rem] text-slate-500 mt-0.5">
                        Required for {{ reportSubtype }} reports — up to 3
                        tenants
                      </p>
                    </div>
                    <div class="divide-y divide-slate-700/50">
                      <div
                        v-for="(tenant, tIdx) in signatureState.tenants"
                        :key="tIdx"
                      ...
                      >
                        <div class="grid grid-cols-2 gap-3">
                          <div>
                            <label
                              class="block text-[0.6rem] font-bold text-slate-500 uppercase mb-1"
                              >Tenant {{ tIdx + 1 }} Name</label
                            >
                            <input
                              v-model="tenant.name"
                              type="text"
                        ...
                        >
                          <canvas
                            :ref="(el) => setTenantCanvasRef(tIdx, el)"
                            class="w-full"
                            style="height: 120px"
                          />
                          <button
                            @click="clearTenantSignature(tIdx)"
                            class="absolute top-2 right-2 px-2 py-1 rounded-lg bg-slate-200 hover:bg-slate-300 text-slate-600 text-[10px] font-bold transition-colors"
                          >
                            Clear
                          </button>
                ...
                <div class="flex gap-3 px-5 py-5">
                  ...
                  <button
                    @click="confirmSubmit"
                    :disabled="hasAnyUploading || !canSubmit"
    ...
    <Teleport to="body">
      ...
      >
        <div
          v-if="confirmClear.open"
          class="fixed inset-0 z-50 flex items-center justify-center px-4"
        >
          <div
            class="absolute inset-0 bg-black/70 backdrop-blur-sm"
            @click="confirmClear.open = false"
          />
          <div
          ...
          >
            ...
            <h3 class="text-white font-black text-base mb-1">
              Clear Checklist?
            </h3>
            <p class="text-slate-400 text-sm mb-5">
              All inspection data, statuses, notes, property setup, and photos
              will be removed.
            </p>
            <div class="flex gap-3">
              <button
          ...
          >
            ...
            >
              <div class="flex items-center justify-between mb-5">
                <div>
                  <h2 class="text-white font-extrabold text-base">
                    {{
                      photoModal.queue.length > 0
                        ? `Label
                                        Photo ${photoModal.queueIndex + 1} of ${photoModal.queue.length}`
                        : "Add Photo"
                    }}
                  </h2>
                  <p class="text-slate-400 text-xs mt-0.5">
                    {{ photoModal.roomLabel }}
                  </p>
                </div>
                <button
                  @click="closePhotoModal"
              ...
              <template v-if="photoModal.queue.length > 0">
                ...
                >
                  <img
                    :src="photoModal.queue[photoModal.queueIndex]?.preview"
                    alt="Preview"
                ...
                <!-- Progress dots -->
                <div
                  v-if="photoModal.queue.length > 1"
                  class="flex items-center justify-center gap-1.5 mb-4"
                >
                  <div
                    v-for="(_, qi) in photoModal.queue"
                    :key="qi"
                    class="w-2 h-2 rounded-full transition-colors"
                    :class="
                      qi === photoModal.queueIndex
                        ? 'bg-violet-400'
                        : qi < photoModal.queueIndex
                          ? 'bg-violet-600'
                          : 'bg-slate-700'
                ...
                <div class="mb-5">
                  <label
                    class="block text-xs font-bold text-slate-400 uppercase tracking-widest mb-1.5"
                    >Caption
                    <span
                      class="normal-case font-medium tracking-normal text-slate-500"
                      >— optional</span
                    ></label
                  >
                  <input
                    v-model="photoModal.queue[photoModal.queueIndex].caption"
                    type="text"
                ...
                <div class="flex gap-3">
                  ...
                  <button
                    v-if="photoModal.queueIndex < photoModal.queue.length - 1"
                    @click="nextInQueue"
                  ...
                  <button
                    v-else
                    @click="confirmPhotoQueue"
                    class="flex-1 py-2.5 rounded-xl bg-gradient-to-r from-violet-600 to-fuchsia-600 hover:from-violet-500 hover:to-fuchsia-500 text-white text-sm font-bold transition-all shadow-lg shadow-violet-500/20"
                  >
                    {{
                      photoModal.queue.length === 1
                        ? "Add Photo"
                        : `Add ${photoModal.queue.length}
                                        Photos`
                    }}
                  </button>
                </div>
              ...
              <template v-else>
                ...
                >
                  ...
                  >
                    ...
                    />
                    <span
                      class="text-xs font-bold text-slate-400 group-hover:text-violet-400 transition-colors"
                      >Take Photo</span
                    >
                  </button>
                  <button
...
import {
  ...
  _common,
  getChecklistGroups,
} from "@/features/everhomes/data/inspectionItems.js";
...
const REPORT_TYPES = [
  { key: "entry", label: "Entry Report", disabled: true },
  { key: "routine", label: "Routine Inspection" },
  { key: "exit", label: "Exit Report", disabled: true },
...
const MARKETING_SLOTS = [
  {
    ...
    hint: "Full front view of the property from the street",
  },
  {
    key: "kitchenWide",
    label: "Kitchen Wide",
    hint: "Wide-angle shot showing the full kitchen",
  },
  {
    key: "livingArea",
    label: "Living Area",
    hint: "Main living space — open and well-lit",
  },
  {
    key: "mainBedroom",
    label: "Main Bedroom",
    hint: "Primary bedroom — bed area and window",
  },
  {
    key: "bathroom",
    label: "Bathroom",
    hint: "Main bathroom — clean and bright",
  },
  {
    key: "outdoorGarden",
    label: "Outdoor / Garden",
    hint: "Backyard, patio, or balcony area",
  },
  {
    key: "streetView",
    label: "Street View",
    hint: "Property from across the street with surroundings",
  },
];

// All status-checkable item IDs for a given room type (excludes input-type items)
function getItemIds(type) {
  return getChecklistGroups(type).flatMap((g) =>
...
function addBedroom() {
  bedrooms.push({ id: _id++, name: "", hasEnsuite: false, isOOA: false });
}
function removeBedroom() {
  if (bedrooms.length > 1) bedrooms.pop();
}
function toggleOptional(key) {
  selectedOptional.has(key)
    ? selectedOptional.delete(key)
    : selectedOptional.add(key);
}
...
function ensureInspectionEntry(id, type) {
  if (!inspectionData[id]) {
    const items = {};
    getItemIds(type).forEach((itemId) => {
      items[itemId] = "unchecked";
    });
    inspectionData[id] = {
      status: "unchecked",
      notes: "",
...
function startInspection() {
  ...
  bedrooms.forEach((bed, i) => {
    ...
    rooms.push({
      id: bId,
      type: "bedroom",
      label: bed.name.trim() || `Bedroom ${i + 1}`,
      isOOA: bed.isOOA,
      isEnsuite: false,
    });
    ...
    if (bed.hasEnsuite) {
      ...
      rooms.push({
        id: eId,
        type: "ensuite",
        label: `${bed.name.trim() || `Bedroom ${i + 1}`} — Ensuite`,
        isOOA: false,
        isEnsuite: true,
      });
  ...
  for (let i = 0; i < bathrooms.value; i++) {
    ...
    rooms.push({
      id: bId,
      type: "bathroom",
      label: bathrooms.value > 1 ? `Bathroom ${i + 1}` : "Bathroom",
      isOOA: false,
      isEnsuite: false,
    });
...
async function uploadPhotoToStorage(file, roomId) {
  if (!inspectionId.value)
    throw new Error("No inspection ID — start inspection first");
...
function hasSkippedPhotos(roomId) {
  return (
    inspectionData[roomId]?.photos?.some((p) => p.uploadStatus === "skipped") ??
    false
  );
}

const hasAnyUploading = computed(() =>
  Object.values(inspectionData).some((d) =>
...
const progressGradient = computed(() => {
  ...
  if (progressPercent.value >= 30)
    return "linear-gradient(90deg,#EA580C,#FB923C)";
...
function setItemStatus(roomId, itemId, value) {
  ...
  inspectionData[roomId].items[itemId] =
    inspectionData[roomId].items[itemId] === value ? "unchecked" : value;
...
function itemRowClass(status) {
  ...
  if (status === "issue")
    return "bg-rose-500/10 border border-rose-500/20 rounded-lg";
...
function accordionBorderStyle(roomId) {
  ...
  return {
    borderColor: borders[status] ?? borders.unchecked,
    background: bgs[status] ?? bgs.unchecked,
  };
}
...
const submitStats = computed(() => {
  ...
  const ok = checklistRooms.value.filter(
    (r) => inspectionData[r.id]?.status === "ok",
  ).length;
  const attention = checklistRooms.value.filter(
    (r) => inspectionData[r.id]?.status === "attention",
  ).length;
  const issues = checklistRooms.value.filter(
    (r) => inspectionData[r.id]?.status === "issue",
  ).length;
  return [
...
const flaggedRooms = computed(() =>
  checklistRooms.value
    .filter((r) =>
      ["issue", "attention"].includes(inspectionData[r.id]?.status),
    )
...
function flaggedRoomStyle(status) {
  if (status === "issue")
    return { borderColor: "#F43F5E30", background: "#F43F5E08" };
  if (status === "attention")
    return { borderColor: "#F59E0B30", background: "#F59E0B08" };
  return {};
}
...
async function confirmSubmit() {
  ...
  firestoreUnsub = onSnapshot(
    ...
    (snap) => {
      ...
      if (data.status === "processing") {
        ...
        submitModal.loading = false;
        submitModal.error =
          data.error ?? "The report generation failed. Please try again.";
      }
    },
  );
  ...
  const sigPayload = {
    ...
    tenants:
      reportSubtype.value === "entry" || reportSubtype.value === "exit"
        ? signatureState.tenants
            .map((t, i) => ({
              name: t.name,
              date: t.date,
  ...
  if (staffSigData) {
    try {
      ...
      const sigFile = new File([sigBlob], "staff_signature.png", {
        type: "image/png",
      });
  ...
  for (let i = 0; i < sigPayload.tenants.length; i++) {
    ...
    try {
      ...
      const file = new File([blob], `tenant_${i + 1}_signature.png`, {
        type: "image/png",
      });
  ...
  try {
    ...
    if (err.name === "AbortError") {
      submitModal.statusMessage =
        "The request is taking a while — the report may still be generating.";
    } else {
      submitModal.statusMessage =
...
async function flushAndCheck() {
  ...
  try {
    ...
    if (!data) {
      ...
      submitModal.loading = false;
      submitModal.error =
        "Report record not found on the server. Your inspection data is safe — please try submitting again.";
    ...
    if (data.status === "complete") {
      ...
      submitModal.error =
        data.error ??
        "Report generation failed. Your data is safe — please try again.";
    } else if (data.status === "processing") {
      submitModal.statusMessage =
        "Report is still being generated. Please wait…";
      startSubmitTimeout();
    } else {
      // Still 'pending' — the HTTP request likely never reached the server
      submitModal.loading = false;
      submitModal.error =
        "The report request may not have reached the server. Please check your connection and try again.";
...
function clearChecklist() {
  ...
  ["dining", "laundry"].forEach((k) => selectedOptional.add(k));
...
function loadFromCache() {
  try {
    ...
    if (typeof data.showMarketing === "boolean")
      showMarketing.value = data.showMarketing;
...
watch(
  [propertyAddress, inspectionDate, inspectorName, inspectorEmail, bathrooms],
  debouncedSave,
);
...
function openPhotoModal(idx) {
  Object.assign(photoModal, {
    open: true,
    roomIdx: idx,
    roomLabel: checklistRooms.value[idx]?.label ?? "",
    preview: null,
    rawFile: null,
    caption: "",
    queue: [],
...
function saveCaptionEdit() {
  const photo =
    inspectionData[captionEdit.roomId]?.photos?.[captionEdit.photoIdx];
  if (photo) photo.caption = captionEdit.caption;
  closeCaptionEdit();
}

function closeCaptionEdit() {
  Object.assign(captionEdit, {
    open: false,
    roomId: null,
    photoIdx: null,
    caption: "",
...
function destroySignaturePads() {
  ...
  signatureState.tenants.forEach((t) => {
    t.name = "";
    t.date = "";
    t.signed = false;
  });
...
const canSubmit = computed(() => {
  if (!signatureState.staffSigned || !signatureState.agreementChecked)
    return false;
  return true;
});
